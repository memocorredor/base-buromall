...
class AdminAcNoRequestController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_ac_no_request_title');
        $this->seo_description = __('seo_admin.local_admin_ac_no_request_description');
        $this->seo_keywords = __('seo_admin.local_admin_ac_no_request_keywords');
        $this->view_icon = 'fas fa-comment-dollar';
        // Rutas del view and form
        $this->form_view = 'admin.ac_no_request';
        $this->form_show = 'admin.ac_no_request.show';
        $this->form_new = 'admin.ac_no_request.new';
        $this->form_create = 'admin.ac_no_request.store';
        $this->form_edit = 'admin.ac_no_request.edit';
        $this->form_update = 'admin.ac_no_request.update';
        $this->form_delete = 'admin.ac_no_request.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = AcNoRequest::paginate(7);
        ...
        // Render del view
        return view('web.admin.ac_no_request.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        if ($data_item != null) {
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.ac_no_request.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
    ...
    public function store(Request $request)
    {
        if ($request->get('process') === 'add') {
            ...
            $data_field->status = $request->get('status');
            $data_field->order_num = $request->get('order_num');
            $data_field->no_item = $request->get('no_item');
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($data_item != null) {
            if ($request->get('process') === 'edit') {
                ...
                $data_item->order_num = $request->get('order_num');
                $data_item->no_item = $request->get('no_item');
