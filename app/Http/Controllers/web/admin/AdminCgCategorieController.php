...
class AdminCgCategorieController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_cg_categorie_title');
        $this->seo_description = __('seo_admin.local_admin_cg_categorie_description');
        $this->seo_keywords = __('seo_admin.local_admin_cg_categorie_keywords');
        $this->view_icon = 'fas fa-th-list';
        // Rutas del view and form
        $this->form_view = 'admin.cg_categorie';
        $this->form_show = 'admin.cg_categorie.show';
        $this->form_new = 'admin.cg_categorie.new';
        $this->form_create = 'admin.cg_categorie.store';
        $this->form_edit = 'admin.cg_categorie.edit';
        $this->form_update = 'admin.cg_categorie.update';
        $this->form_delete = 'admin.cg_categorie.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = CgCategorie::paginate(7);
        ...
        // Render del view
        return view('web.admin.cg_categorie.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        // Carga data para el view
        $data_item = CgCategorie::find($id_a);
        if ($data_item != null) {
            $id_sis = $data_item->id;
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.cg_categorie.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
