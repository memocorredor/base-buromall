...
class AdminCgDepartamentController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_cg_departament_title');
        $this->seo_description = __('seo_admin.local_admin_cg_departament_description');
        $this->seo_keywords = __('seo_admin.local_admin_cg_departament_keywords');
        $this->view_icon = 'fas fa-th-large';
        // Rutas del view and form
        $this->form_view = 'admin.cg_departament';
        $this->form_show = 'admin.cg_departament.show';
        $this->form_new = 'admin.cg_departament.new';
        $this->form_create = 'admin.cg_departament.store';
        $this->form_edit = 'admin.cg_departament.edit';
        $this->form_update = 'admin.cg_departament.update';
        $this->form_delete = 'admin.cg_departament.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = CgDepartament::paginate(7);
        ...
        // Render del view
        return view('web.admin.cg_departament.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        // Carga data para el view
        $data_item = CgDepartament::find($id_a);
        if ($data_item != null) {
            $id_sis = $data_item->id;
            ...
            $icon = $data_item->icon;
            $url_name_es = $data_item->url_name_es;
            ...
            $url_name_en = $data_item->url_name_en;
            ...
            $url_name_pt = $data_item->url_name_pt;
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.cg_departament.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
                ...
                'enable' => $enable,
                'icon' => $icon,
                'url_name_es' => $url_name_es,
                'name_es' => $name_es,
                'title_es' => $title_es,
                'description_es' => $description_es,
                'keywords_es' => $keywords_es,
                'url_name_en' => $url_name_en,
                'name_en' => $name_en,
                'title_en' => $title_en,
                'description_en' => $description_en,
                'keywords_en' => $keywords_en,
                'url_name_pt' => $url_name_pt,
                'name_pt' => $name_pt,
                'title_pt' => $title_pt,
    ...
    public function update(Request $request, $id)
    {
        ...
        $data_item = CgDepartament::find($id);
        if ($data_item != null) {
            if ($request->get('process') === 'edit') {
                ...
                $data_item->url_name_es = $request->get('url_name_es');
                ...
                $data_item->url_name_en = $request->get('url_name_en');
                ...
                $data_item->url_name_pt = $request->get('url_name_pt');
                ...
                $data_item->url_img = $request->get('url_img');
