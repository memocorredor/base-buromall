...
class AdminPayErrorAvsController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_pay_error_avs_title');
        $this->seo_description = __('seo_admin.local_admin_pay_error_avs_description');
        $this->seo_keywords = __('seo_admin.local_admin_pay_error_avs_keywords');
        $this->view_icon = 'fas fa-credit-card';
        // Rutas del view and form
        $this->form_view = 'admin.pay_error_avs';
        $this->form_show = 'admin.pay_error_avs.show';
        $this->form_new = 'admin.pay_error_avs.new';
        $this->form_create = 'admin.pay_error_avs.store';
        $this->form_edit = 'admin.pay_error_avs.edit';
        $this->form_update = 'admin.pay_error_avs.update';
        $this->form_delete = 'admin.pay_error_avs.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = PayErrorAvs::paginate(7);
        ...
        // Render del view
        return view('web.admin.pay_error_avs.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        // Carga data para el view
        $data_item = PayErrorAvs::find($id_a);
        if ($data_item != null) {
            $id_sis = $data_item->id;
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.pay_error_avs.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
