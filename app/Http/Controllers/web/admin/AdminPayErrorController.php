...
class AdminPayErrorController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_pay_error_title');
        $this->seo_description = __('seo_admin.local_admin_pay_error_description');
        $this->seo_keywords = __('seo_admin.local_admin_pay_error_keywords');
        $this->view_icon = 'fas fa-exclamation-triangle';
        // Rutas del view and form
        $this->form_view = 'admin.pay_error';
        $this->form_show = 'admin.pay_error.show';
        $this->form_new = 'admin.pay_error.new';
        $this->form_create = 'admin.pay_error.store';
        $this->form_edit = 'admin.pay_error.edit';
        $this->form_update = 'admin.pay_error.update';
        $this->form_delete = 'admin.pay_error.delete';
    }
    ...
    public function index()
    {
        ...
        // Render del view
        return view('web.admin.pay_error.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        if ($data_item != null) {
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.pay_error.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
