...
class AdminPayErrorCvvController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_pay_error_cvv_title');
        $this->seo_description = __('seo_admin.local_admin_pay_error_cvv_description');
        $this->seo_keywords = __('seo_admin.local_admin_pay_error_cvv_keywords');
        $this->view_icon = 'far fa-credit-card';
        // Rutas del view and form
        $this->form_view = 'admin.pay_error_cvv';
        $this->form_show = 'admin.pay_error_cvv.show';
        $this->form_new = 'admin.pay_error_cvv.new';
        $this->form_create = 'admin.pay_error_cvv.store';
        $this->form_edit = 'admin.pay_error_cvv.edit';
        $this->form_update = 'admin.pay_error_cvv.update';
        $this->form_delete = 'admin.pay_error_cvv.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = PayErrorCvv::paginate(7);
        ...
        // Render del view
        return view('web.admin.pay_error_cvv.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        // Carga data para el view
        $data_item = PayErrorCvv::find($id_a);
        if ($data_item != null) {
            $id_sis = $data_item->id;
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.pay_error_cvv.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($data_item != null) {
            if ($request->get('process') === 'edit') {
                ...
                $data_item->error = $request->get('error');
