...
class AdminPayTaxController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_pay_tax_title');
        $this->seo_description = __('seo_admin.local_admin_pay_tax_description');
        $this->seo_keywords = __('seo_admin.local_admin_pay_tax_keywords');
        $this->view_icon = 'fas fa-receipt';
        // Rutas del view and form
        $this->form_view = 'admin.pay_tax';
        $this->form_show = 'admin.pay_tax.show';
        $this->form_new = 'admin.pay_tax.new';
        $this->form_create = 'admin.pay_tax.store';
        $this->form_edit = 'admin.pay_tax.edit';
        $this->form_update = 'admin.pay_tax.update';
        $this->form_delete = 'admin.pay_tax.delete';
    }
    ...
    public function index()
    {
        ...
        // Render del view
        return view('web.admin.pay_tax.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        if ($data_item != null) {
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.pay_tax.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
    ...
    public function store(Request $request)
    {
        if ($request->get('process') === 'add') {
            ...
            $data_field->tax = $request->get('tax');
