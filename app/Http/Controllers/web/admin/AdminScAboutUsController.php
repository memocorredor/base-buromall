...
class AdminScAboutUsController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_sc_aboutus_title');
        $this->seo_description = __('seo_admin.local_admin_sc_aboutus_description');
        $this->seo_keywords = __('seo_admin.local_admin_sc_aboutus_keywords');
        $this->view_icon = 'fas fa-child';
        // Rutas del view and form
        $this->form_view = 'admin.sc_aboutus';
        $this->form_show = 'admin.sc_aboutus.show';
        $this->form_new = 'admin.sc_aboutus.new';
        $this->form_create = 'admin.sc_aboutus.store';
        $this->form_edit = 'admin.sc_aboutus.edit';
        $this->form_update = 'admin.sc_aboutus.update';
        $this->form_delete = 'admin.sc_aboutus.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = ScAboutUs::paginate(7);
        ...
        // Render del view
        return view('web.admin.sc_aboutus.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        if ($data_item != null) {
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.sc_aboutus.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
