...
use Buromall\Models\ScCancelation;
...
class AdminScCancelationController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_sc_cancelation_title');
        $this->seo_description = __('seo_admin.local_admin_sc_cancelation_description');
        $this->seo_keywords = __('seo_admin.local_admin_sc_cancelation_keywords');
        $this->view_icon = 'fas fa-ban';
        // Rutas del view and form
        $this->form_view = 'admin.sc_cancelation';
        $this->form_show = 'admin.sc_cancelation.show';
        $this->form_new = 'admin.sc_cancelation.new';
        $this->form_create = 'admin.sc_cancelation.store';
        $this->form_edit = 'admin.sc_cancelation.edit';
        $this->form_update = 'admin.sc_cancelation.update';
        $this->form_delete = 'admin.sc_cancelation.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = ScCancelation::paginate(7);
        ...
        // Render del view
        return view('web.admin.sc_cancelation.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        // Carga data para el view
        $data_item = ScCancelation::find($id_a);
        if ($data_item != null) {
            $id_sis = $data_item->id;
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.sc_cancelation.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
    ...
    public function update(Request $request, $id)
    {
        ...
        $data_item = ScCancelation::find($id);
        if ($data_item != null) {
