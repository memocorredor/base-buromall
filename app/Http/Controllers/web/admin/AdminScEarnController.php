...
class AdminScEarnController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_sc_earn_title');
        $this->seo_description = __('seo_admin.local_admin_sc_earn_description');
        $this->seo_keywords = __('seo_admin.local_admin_sc_earn_keywords');
        $this->view_icon = 'fas fa-trophy';
        // Rutas del view and form
        $this->form_view = 'admin.sc_earn';
        $this->form_show = 'admin.sc_earn.show';
        $this->form_new = 'admin.sc_earn.new';
        $this->form_create = 'admin.sc_earn.store';
        $this->form_edit = 'admin.sc_earn.edit';
        $this->form_update = 'admin.sc_earn.update';
        $this->form_delete = 'admin.sc_earn.delete';
    }
    ...
    public function index()
    {
        ...
        // Render del view
        return view('web.admin.sc_earn.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        if ($data_item != null) {
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.sc_earn.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
