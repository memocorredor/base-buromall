...
class AdminScFaqController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_sc_faq_title');
        $this->seo_description = __('seo_admin.local_admin_sc_faq_description');
        $this->seo_keywords = __('seo_admin.local_admin_sc_faq_keywords');
        $this->view_icon = 'fas fa-question-circle';
        // Rutas del view and form
        $this->form_view = 'admin.sc_faq';
        $this->form_show = 'admin.sc_faq.show';
        $this->form_new = 'admin.sc_faq.new';
        $this->form_create = 'admin.sc_faq.store';
        $this->form_edit = 'admin.sc_faq.edit';
        $this->form_update = 'admin.sc_faq.update';
        $this->form_delete = 'admin.sc_faq.delete';
    }
    ...
    public function index()
    {
        ...
        // Render del view
        return view('web.admin.sc_faq.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        if ($data_item != null) {
            ...
            // Carga de combos
            $data_categories_faq_id = ScCategorieFaq::all();
            // Carga los metas en las variables
            $this->setMeta();
            // Carga los datos de la web
            $for_meta_sis = $this->meta_sis;
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.sc_faq.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
                ...
                'data_item' => $data_item,
                'data_categories_faq_id' => $data_categories_faq_id,
                'id' => $id_sis,
                'form_action' => __('app_messages.local_action_show'),
                'created_at' => $date_created,
                'updated_at' => $date_edit,
                'enable' => $enable,
                'categories_faq_id' => $categories_faq_id,
                'title_es' => $title_es,
                'text_es' => $text_es,
                'title_en' => $title_en,
                'text_en' => $text_en,
    ...
    public function store(Request $request)
    {
        if ($request->get('process') === 'add') {
            ...
            // Crea la instancia
            $data_field = new ScFaq();
            $data_field->enable = $request->get('enable');
            $data_field->categories_faq_id = $request->get('categories_faq_id');
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($data_item != null) {
            if ($request->get('process') === 'edit') {
                ...
                $data_item->categories_faq_id = $request->get('categories_faq_id');
