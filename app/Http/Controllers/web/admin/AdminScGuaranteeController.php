...
use Buromall\Models\ScGuarantee;
...
class AdminScGuaranteeController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_sc_guarantee_title');
        $this->seo_description = __('seo_admin.local_admin_sc_guarantee_description');
        $this->seo_keywords = __('seo_admin.local_admin_sc_guarantee_keywords');
        $this->view_icon = 'fas fa-hand-holding-usd';
        // Rutas del view and form
        $this->form_view = 'admin.sc_guarantee';
        $this->form_show = 'admin.sc_guarantee.show';
        $this->form_new = 'admin.sc_guarantee.new';
        $this->form_create = 'admin.sc_guarantee.store';
        $this->form_edit = 'admin.sc_guarantee.edit';
        $this->form_update = 'admin.sc_guarantee.update';
        $this->form_delete = 'admin.sc_guarantee.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = ScGuarantee::paginate(7);
        ...
        // Render del view
        return view('web.admin.sc_guarantee.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        // Carga data para el view
        $data_item = ScGuarantee::find($id_a);
        if ($data_item != null) {
            $id_sis = $data_item->id;
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.sc_guarantee.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
