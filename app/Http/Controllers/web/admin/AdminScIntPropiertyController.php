...
use Buromall\Models\ScIntPropierty;
...
class AdminScIntPropiertyController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_sc_intpropierty_title');
        $this->seo_description = __('seo_admin.local_admin_sc_intpropierty_description');
        $this->seo_keywords = __('seo_admin.local_admin_sc_intpropierty_keywords');
        $this->view_icon = 'fas fa-graduation-cap';
        // Rutas del view and form
        $this->form_view = 'admin.sc_intpropierty';
        $this->form_show = 'admin.sc_intpropierty.show';
        $this->form_new = 'admin.sc_intpropierty.new';
        $this->form_create = 'admin.sc_intpropierty.store';
        $this->form_edit = 'admin.sc_intpropierty.edit';
        $this->form_update = 'admin.sc_intpropierty.update';
        $this->form_delete = 'admin.sc_intpropierty.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = ScIntPropierty::paginate(7);
        ...
        // Render del view
        return view('web.admin.sc_intpropierty.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        // Carga data para el view
        $data_item = ScIntPropierty::find($id_a);
        if ($data_item != null) {
            $id_sis = $data_item->id;
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.sc_intpropierty.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
    ...
    public function update(Request $request, $id)
    {
        ...
        $data_item = ScIntPropierty::find($id);
        if ($data_item != null) {
