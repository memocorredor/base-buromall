...
class AdminScMisionController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_sc_mision_title');
        $this->seo_description = __('seo_admin.local_admin_sc_mision_description');
        $this->seo_keywords = __('seo_admin.local_admin_sc_mision_keywords');
        $this->view_icon = 'fas fa-rocket';
        // Rutas del view and form
        $this->form_view = 'admin.sc_mision';
        $this->form_show = 'admin.sc_mision.show';
        $this->form_new = 'admin.sc_mision.new';
        $this->form_create = 'admin.sc_mision.store';
        $this->form_edit = 'admin.sc_mision.edit';
        $this->form_update = 'admin.sc_mision.update';
        $this->form_delete = 'admin.sc_mision.delete';
    }
    ...
    public function index()
    {
        ...
        // Render del view
        return view('web.admin.sc_mision.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        if ($data_item != null) {
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.sc_mision.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
