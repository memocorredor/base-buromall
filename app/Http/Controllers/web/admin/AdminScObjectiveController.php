...
use Buromall\Models\ScObjective;
...
class AdminScObjectiveController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_sc_objective_title');
        $this->seo_description = __('seo_admin.local_admin_sc_objective_description');
        $this->seo_keywords = __('seo_admin.local_admin_sc_objective_keywords');
        $this->view_icon = 'fas fa-bomb';
        // Rutas del view and form
        $this->form_view = 'admin.sc_objective';
        $this->form_show = 'admin.sc_objective.show';
        $this->form_new = 'admin.sc_objective.new';
        $this->form_create = 'admin.sc_objective.store';
        $this->form_edit = 'admin.sc_objective.edit';
        $this->form_update = 'admin.sc_objective.update';
        $this->form_delete = 'admin.sc_objective.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = ScObjective::paginate(7);
        ...
        // Render del view
        return view('web.admin.sc_objective.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        // Carga data para el view
        $data_item = ScObjective::find($id_a);
        if ($data_item != null) {
            $id_sis = $data_item->id;
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.sc_objective.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
