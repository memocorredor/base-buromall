...
class AdminScPrivacyController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_sc_privacy_title');
        $this->seo_description = __('seo_admin.local_admin_sc_privacy_description');
        $this->seo_keywords = __('seo_admin.local_admin_sc_privacy_keywords');
        $this->view_icon = 'fas fa-user-secret';
        // Rutas del view and form
        $this->form_view = 'admin.sc_privacy';
        $this->form_show = 'admin.sc_privacy.show';
        $this->form_new = 'admin.sc_privacy.new';
        $this->form_create = 'admin.sc_privacy.store';
        $this->form_edit = 'admin.sc_privacy.edit';
        $this->form_update = 'admin.sc_privacy.update';
        $this->form_delete = 'admin.sc_privacy.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = ScPrivacy::paginate(7);
        ...
        // Render del view
        return view('web.admin.sc_privacy.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        if ($data_item != null) {
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.sc_privacy.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
