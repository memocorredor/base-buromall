...
use Buromall\Models\ScRecharge;
...
class AdminScRechargeController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_sc_recharge_title');
        $this->seo_description = __('seo_admin.local_admin_sc_recharge_description');
        $this->seo_keywords = __('seo_admin.local_admin_sc_recharge_keywords');
        $this->view_icon = 'fas fa-donate';
        // Rutas del view and form
        $this->form_view = 'admin.sc_recharge';
        $this->form_show = 'admin.sc_recharge.show';
        $this->form_new = 'admin.sc_recharge.new';
        $this->form_create = 'admin.sc_recharge.store';
        $this->form_edit = 'admin.sc_recharge.edit';
        $this->form_update = 'admin.sc_recharge.update';
        $this->form_delete = 'admin.sc_recharge.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = ScRecharge::paginate(7);
        ...
        // Render del view
        return view('web.admin.sc_recharge.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        // Carga data para el view
        $data_item = ScRecharge::find($id_a);
        if ($data_item != null) {
            $id_sis = $data_item->id;
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.sc_recharge.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
