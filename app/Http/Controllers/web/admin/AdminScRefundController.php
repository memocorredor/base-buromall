...
class AdminScRefundController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_sc_refund_title');
        $this->seo_description = __('seo_admin.local_admin_sc_refund_description');
        $this->seo_keywords = __('seo_admin.local_admin_sc_refund_keywords');
        $this->view_icon = 'fas fa-handshake';
        // Rutas del view and form
        $this->form_view = 'admin.sc_refund';
        $this->form_show = 'admin.sc_refund.show';
        $this->form_new = 'admin.sc_refund.new';
        $this->form_create = 'admin.sc_refund.store';
        $this->form_edit = 'admin.sc_refund.edit';
        $this->form_update = 'admin.sc_refund.update';
        $this->form_delete = 'admin.sc_refund.delete';
    }
    ...
    public function index()
    {
        ...
        // Render del view
        return view('web.admin.sc_refund.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        if ($data_item != null) {
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.sc_refund.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
