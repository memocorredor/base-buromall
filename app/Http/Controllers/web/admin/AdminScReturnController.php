...
class AdminScReturnController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_sc_return_title');
        $this->seo_description = __('seo_admin.local_admin_sc_return_description');
        $this->seo_keywords = __('seo_admin.local_admin_sc_return_keywords');
        $this->view_icon = 'fas fa-people-carry';
        // Rutas del view and form
        $this->form_view = 'admin.sc_return';
        $this->form_show = 'admin.sc_return.show';
        $this->form_new = 'admin.sc_return.new';
        $this->form_create = 'admin.sc_return.store';
        $this->form_edit = 'admin.sc_return.edit';
        $this->form_update = 'admin.sc_return.update';
        $this->form_delete = 'admin.sc_return.delete';
    }
    ...
    public function index()
    {
        ...
        // Render del view
        return view('web.admin.sc_return.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        if ($data_item != null) {
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.sc_return.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
