...
use Buromall\Models\ScShipping;
...
class AdminScShippingController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_sc_shipping_title');
        $this->seo_description = __('seo_admin.local_admin_sc_shipping_description');
        $this->seo_keywords = __('seo_admin.local_admin_sc_shipping_keywords');
        $this->view_icon = 'fas fa-dolly';
        // Rutas del view and form
        $this->form_view = 'admin.sc_shipping';
        $this->form_show = 'admin.sc_shipping.show';
        $this->form_new = 'admin.sc_shipping.new';
        $this->form_create = 'admin.sc_shipping.store';
        $this->form_edit = 'admin.sc_shipping.edit';
        $this->form_update = 'admin.sc_shipping.update';
        $this->form_delete = 'admin.sc_shipping.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = ScShipping::paginate(7);
        ...
        // Render del view
        return view('web.admin.sc_shipping.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        // Carga data para el view
        $data_item = ScShipping::find($id_a);
        if ($data_item != null) {
            $id_sis = $data_item->id;
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.sc_shipping.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
