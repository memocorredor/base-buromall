...
class AdminScSocialController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_sc_social_title');
        $this->seo_description = __('seo_admin.local_admin_sc_social_description');
        $this->seo_keywords = __('seo_admin.local_admin_sc_social_keywords');
        $this->view_icon = 'fas fa-share-alt-square';
        // Rutas del view and form
        $this->form_view = 'admin.sc_social';
        $this->form_show = 'admin.sc_social.show';
        $this->form_new = 'admin.sc_social.new';
        $this->form_create = 'admin.sc_social.store';
        $this->form_edit = 'admin.sc_social.edit';
        $this->form_update = 'admin.sc_social.update';
        $this->form_delete = 'admin.sc_social.delete';
    }
    ...
    public function index()
    {
        ...
        // Render del view
        return view('web.admin.sc_social.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        if ($data_item != null) {
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.sc_social.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
