...
class AdminScTermController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_sc_term_title');
        $this->seo_description = __('seo_admin.local_admin_sc_term_description');
        $this->seo_keywords = __('seo_admin.local_admin_sc_term_keywords');
        $this->view_icon = 'fas fa-balance-scale';
        // Rutas del view and form
        $this->form_view = 'admin.sc_term';
        $this->form_show = 'admin.sc_term.show';
        $this->form_new = 'admin.sc_term.new';
        $this->form_create = 'admin.sc_term.store';
        $this->form_edit = 'admin.sc_term.edit';
        $this->form_update = 'admin.sc_term.update';
        $this->form_delete = 'admin.sc_term.delete';
    }
    ...
    public function index()
    {
        ...
        // Render del view
        return view('web.admin.sc_term.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        if ($data_item != null) {
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.sc_term.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
