...
class AdminScVisionController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_sc_vision_title');
        $this->seo_description = __('seo_admin.local_admin_sc_vision_description');
        $this->seo_keywords = __('seo_admin.local_admin_sc_vision_keywords');
        $this->view_icon = 'fas fa-eye';
        // Rutas del view and form
        $this->form_view = 'admin.sc_vision';
        $this->form_show = 'admin.sc_vision.show';
        $this->form_new = 'admin.sc_vision.new';
        $this->form_create = 'admin.sc_vision.store';
        $this->form_edit = 'admin.sc_vision.edit';
        $this->form_update = 'admin.sc_vision.update';
        $this->form_delete = 'admin.sc_vision.delete';
    }
    ...
    public function index()
    {
        ...
        // Render del view
        return view('web.admin.sc_vision.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        if ($data_item != null) {
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.sc_vision.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
