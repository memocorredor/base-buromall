...
class AdminStatusOrderController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_status_order_title');
        $this->seo_description = __('seo_admin.local_admin_status_order_description');
        $this->seo_keywords = __('seo_admin.local_admin_status_order_keywords');
        $this->view_icon = 'fas fa-tasks';
        // Rutas del view and form
        $this->form_view = 'admin.status_order';
        $this->form_show = 'admin.status_order.show';
        $this->form_new = 'admin.status_order.new';
        $this->form_create = 'admin.status_order.store';
        $this->form_edit = 'admin.status_order.edit';
        $this->form_update = 'admin.status_order.update';
        $this->form_delete = 'admin.status_order.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = StatusOrder::paginate(7);
        ...
        // Render del view
        return view('web.admin.status_order.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        // Carga data para el view
        $data_item = StatusOrder::find($id_a);
        if ($data_item != null) {
            $id_sis = $data_item->id;
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.status_order.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
