...
class AdminStatusPaymentController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_status_payment_title');
        $this->seo_description = __('seo_admin.local_admin_status_payment_description');
        $this->seo_keywords = __('seo_admin.local_admin_status_payment_keywords');
        $this->view_icon = 'fas fa-cash-register';
        // Rutas del view and form
        $this->form_view = 'admin.status_payment';
        $this->form_show = 'admin.status_payment.show';
        $this->form_new = 'admin.status_payment.new';
        $this->form_create = 'admin.status_payment.store';
        $this->form_edit = 'admin.status_payment.edit';
        $this->form_update = 'admin.status_payment.update';
        $this->form_delete = 'admin.status_payment.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = StatusPayment::paginate(7);
        ...
        // Render del view
        return view('web.admin.status_payment.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        // Carga data para el view
        $data_item = StatusPayment::find($id_a);
        if ($data_item != null) {
            $id_sis = $data_item->id;
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.status_payment.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
    ...
    public function update(Request $request, $id)
    {
        ...
        $data_item = StatusPayment::find($id);
        if ($data_item != null) {
