...
class AdminStatusProductController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_status_product_title');
        $this->seo_description = __('seo_admin.local_admin_status_product_description');
        $this->seo_keywords = __('seo_admin.local_admin_status_product_keywords');
        $this->view_icon = 'fas fa-heartbeat';
        // Rutas del view and form
        $this->form_view = 'admin.status_product';
        $this->form_show = 'admin.status_product.show';
        $this->form_new = 'admin.status_product.new';
        $this->form_create = 'admin.status_product.store';
        $this->form_edit = 'admin.status_product.edit';
        $this->form_update = 'admin.status_product.update';
        $this->form_delete = 'admin.status_product.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = StatusProduct::paginate(7);
        ...
        // Render del view
        return view('web.admin.status_product.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        // Carga data para el view
        $data_item = StatusProduct::find($id_a);
        if ($data_item != null) {
            $id_sis = $data_item->id;
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.status_product.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
    ...
    public function update(Request $request, $id)
    {
        ...
        $data_item = StatusProduct::find($id);
        if ($data_item != null) {
