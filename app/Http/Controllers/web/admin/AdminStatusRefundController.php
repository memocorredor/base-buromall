...
class AdminStatusRefundController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_status_refund_title');
        $this->seo_description = __('seo_admin.local_admin_status_refund_description');
        $this->seo_keywords = __('seo_admin.local_admin_status_refund_keywords');
        $this->view_icon = 'fas fa-clipboard-check';
        // Rutas del view and form
        $this->form_view = 'admin.status_refund';
        $this->form_show = 'admin.status_refund.show';
        $this->form_new = 'admin.status_refund.new';
        $this->form_create = 'admin.status_refund.store';
        $this->form_edit = 'admin.status_refund.edit';
        $this->form_update = 'admin.status_refund.update';
        $this->form_delete = 'admin.status_refund.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = StatusRefund::paginate(7);
        ...
        // Render del view
        return view('web.admin.status_refund.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        // Carga data para el view
        $data_item = StatusRefund::find($id_a);
        if ($data_item != null) {
            $id_sis = $data_item->id;
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.status_refund.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
    ...
    public function update(Request $request, $id)
    {
        ...
        $data_item = StatusRefund::find($id);
        if ($data_item != null) {
