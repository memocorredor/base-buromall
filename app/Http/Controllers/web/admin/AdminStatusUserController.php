...
class AdminStatusUserController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_status_user_title');
        $this->seo_description = __('seo_admin.local_admin_status_user_description');
        $this->seo_keywords = __('seo_admin.local_admin_status_user_keywords');
        $this->view_icon = 'fas fa-user-md';
        // Rutas del view and form
        $this->form_view = 'admin.status_user';
        $this->form_show = 'admin.status_user.show';
        $this->form_new = 'admin.status_user.new';
        $this->form_create = 'admin.status_user.store';
        $this->form_edit = 'admin.status_user.edit';
        $this->form_update = 'admin.status_user.update';
        $this->form_delete = 'admin.status_user.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = StatusUser::paginate(7);
        ...
        // Render del view
        return view('web.admin.status_user.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        // Carga data para el view
        $data_item = StatusUser::find($id_a);
        if ($data_item != null) {
            $id_sis = $data_item->id;
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.status_user.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
