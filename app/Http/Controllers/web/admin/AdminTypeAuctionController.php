...
class AdminTypeAuctionController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_types_auction_title');
        $this->seo_description = __('seo_admin.local_admin_types_auction_description');
        $this->seo_keywords = __('seo_admin.local_admin_types_auction_keywords');
        $this->view_icon = 'fas fa-gavel';
        // Rutas del view and form
        $this->form_view = 'admin.type_auction';
        $this->form_show = 'admin.type_auction.show';
        $this->form_new = 'admin.type_auction.new';
        $this->form_create = 'admin.type_auction.store';
        $this->form_edit = 'admin.type_auction.edit';
        $this->form_update = 'admin.type_auction.update';
        $this->form_delete = 'admin.type_auction.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = TypeAuction::paginate(7);
        ...
        // Render del view
        return view('web.admin.type_auction.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        // Carga data para el view
        $data_item = TypeAuction::find($id_a);
        if ($data_item != null) {
            $id_sis = $data_item->id;
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.type_auction.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
