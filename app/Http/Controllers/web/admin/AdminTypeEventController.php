...
class AdminTypeEventController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_types_event_title');
        $this->seo_description = __('seo_admin.local_admin_types_event_description');
        $this->seo_keywords = __('seo_admin.local_admin_types_event_keywords');
        $this->view_icon = 'fas fa-theater-masks';
        // Rutas del view and form
        $this->form_view = 'admin.type_event';
        $this->form_show = 'admin.type_event.show';
        $this->form_new = 'admin.type_event.new';
        $this->form_create = 'admin.type_event.store';
        $this->form_edit = 'admin.type_event.edit';
        $this->form_update = 'admin.type_event.update';
        $this->form_delete = 'admin.type_event.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = TypeEvent::paginate(7);
        ...
        // Render del view
        return view('web.admin.type_event.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        if ($data_item != null) {
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.type_event.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
