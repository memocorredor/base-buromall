...
class AdminTypeIdentificationController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_types_identification_title');
        $this->seo_description = __('seo_admin.local_admin_types_identification_description');
        $this->seo_keywords = __('seo_admin.local_admin_types_identification_keywords');
        $this->view_icon = 'fas fa-search-location';
        // Rutas del view and form
        $this->form_view = 'admin.type_identification';
        $this->form_show = 'admin.type_identification.show';
        $this->form_new = 'admin.type_identification.new';
        $this->form_create = 'admin.type_identification.store';
        $this->form_edit = 'admin.type_identification.edit';
        $this->form_update = 'admin.type_identification.update';
        $this->form_delete = 'admin.type_identification.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = TypeIdentification::paginate(7);
        ...
        // Render del view
        return view('web.admin.type_identification.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        // Carga data para el view
        $data_item = TypeIdentification::find($id_a);
        if ($data_item != null) {
            $id_sis = $data_item->id;
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.type_identification.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
    ...
    public function update(Request $request, $id)
    {
        ...
        $data_item = TypeIdentification::find($id);
        if ($data_item != null) {
