...
class AdminTypePaymentController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_types_payment_title');
        $this->seo_description = __('seo_admin.local_admin_types_payment_description');
        $this->seo_keywords = __('seo_admin.local_admin_types_payment_keywords');
        $this->view_icon = 'fas fa-hand-holding-usd';
        // Rutas del view and form
        $this->form_view = 'admin.type_payment';
        $this->form_show = 'admin.type_payment.show';
        $this->form_new = 'admin.type_payment.new';
        $this->form_create = 'admin.type_payment.store';
        $this->form_edit = 'admin.type_payment.edit';
        $this->form_update = 'admin.type_payment.update';
        $this->form_delete = 'admin.type_payment.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = TypePayment::paginate(7);
        ...
        // Render del view
        return view('web.admin.type_payment.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        // Carga data para el view
        $data_item = TypePayment::find($id_a);
        if ($data_item != null) {
            $id_sis = $data_item->id;
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.type_payment.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
