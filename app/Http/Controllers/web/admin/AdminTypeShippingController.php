...
class AdminTypeShippingController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_types_shipping_title');
        $this->seo_description = __('seo_admin.local_admin_types_shipping_description');
        $this->seo_keywords = __('seo_admin.local_admin_types_shipping_keywords');
        $this->view_icon = 'fas fa-luggage-cart';
        // Rutas del view and form
        $this->form_view = 'admin.type_shipping';
        $this->form_show = 'admin.type_shipping.show';
        $this->form_new = 'admin.type_shipping.new';
        $this->form_create = 'admin.type_shipping.store';
        $this->form_edit = 'admin.type_shipping.edit';
        $this->form_update = 'admin.type_shipping.update';
        $this->form_delete = 'admin.type_shipping.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = TypeShipping::paginate(7);
        ...
        // Render del view
        return view('web.admin.type_shipping.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        // Carga data para el view
        $data_item = TypeShipping::find($id_a);
        if ($data_item != null) {
            $id_sis = $data_item->id;
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.type_shipping.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
    ...
    public function update(Request $request, $id)
    {
        ...
        $data_item = TypeShipping::find($id);
        if ($data_item != null) {
