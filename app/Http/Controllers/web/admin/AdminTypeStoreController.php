...
class AdminTypeStoreController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_types_store_title');
        $this->seo_description = __('seo_admin.local_admin_types_store_description');
        $this->seo_keywords = __('seo_admin.local_admin_types_store_keywords');
        $this->view_icon = 'fas fa-store';
        // Rutas del view and form
        $this->form_view = 'admin.type_store';
        $this->form_show = 'admin.type_store.show';
        $this->form_new = 'admin.type_store.new';
        $this->form_create = 'admin.type_store.store';
        $this->form_edit = 'admin.type_store.edit';
        $this->form_update = 'admin.type_store.update';
        $this->form_delete = 'admin.type_store.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = TypeStore::paginate(7);
        ...
        // Render del view
        return view('web.admin.type_store.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        if ($data_item != null) {
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.type_store.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
