...
class AdminTypeTransactionController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_types_transaction_title');
        $this->seo_description = __('seo_admin.local_admin_types_transaction_description');
        $this->seo_keywords = __('seo_admin.local_admin_types_transaction_keywords');
        $this->view_icon = 'fas fa-exchange-alt';
        // Rutas del view and form
        $this->form_view = 'admin.type_transaction';
        $this->form_show = 'admin.type_transaction.show';
        $this->form_new = 'admin.type_transaction.new';
        $this->form_create = 'admin.type_transaction.store';
        $this->form_edit = 'admin.type_transaction.edit';
        $this->form_update = 'admin.type_transaction.update';
        $this->form_delete = 'admin.type_transaction.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = TypeTransaction::paginate(7);
        ...
        // Render del view
        return view('web.admin.type_transaction.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        // Carga data para el view
        $data_item = TypeTransaction::find($id_a);
        if ($data_item != null) {
            $id_sis = $data_item->id;
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.type_transaction.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
    ...
    public function store(Request $request)
    {
        if ($request->get('process') === 'add') {
            ...
            // Crea la instancia
            $data_field = new TypeTransaction();
    ...
    public function update(Request $request, $id)
    {
        ...
        $data_item = TypeTransaction::find($id);
        if ($data_item != null) {
