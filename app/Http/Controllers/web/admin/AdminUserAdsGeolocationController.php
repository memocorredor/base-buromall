...
use Buromall\Models\UserAdsGeolocation;
...
class AdminUserAdsGeolocationController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_ads_geolocation_title');
        $this->seo_description = __('seo_admin.local_admin_ads_geolocation_description');
        $this->seo_keywords = __('seo_admin.local_admin_ads_geolocation_keywords');
        $this->view_icon = 'fas fa-satellite-dish';
        // Rutas del view and form
        $this->form_view = 'admin.ads_geolocation';
        $this->form_show = 'admin.ads_geolocation.show';
        $this->form_new = 'admin.ads_geolocation.new';
        $this->form_create = 'admin.ads_geolocation.store';
        $this->form_edit = 'admin.ads_geolocation.edit';
        $this->form_update = 'admin.ads_geolocation.update';
        $this->form_delete = 'admin.ads_geolocation.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = UserAdsGeolocation::paginate(7);
        ...
        // Render del view
        return view('web.admin.user_ads_geolocations.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        // Carga data para el view
        $data_item = UserAdsGeolocation::find($id_a);
        if ($data_item != null) {
            $id_sis = $data_item->id;
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.user_ads_geolocations.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
    ...
    public function store(Request $request)
    {
        if ($request->get('process') === 'add') {
            ...
            // Crea la instancia
            $data_field = new UserAdsGeolocation();
    ...
    public function update(Request $request, $id)
    {
        ...
        $data_item = UserAdsGeolocation::find($id);
        if ($data_item != null) {
