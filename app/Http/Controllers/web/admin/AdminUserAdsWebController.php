...
use Buromall\Models\UserAdsWeb;
...
class AdminUserAdsWebController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_ads_web_title');
        $this->seo_description = __('seo_admin.local_admin_ads_web_description');
        $this->seo_keywords = __('seo_admin.local_admin_ads_web_keywords');
        $this->view_icon = 'fas fa-laptop';
        // Rutas del view and form
        $this->form_view = 'admin.ads_web';
        $this->form_show = 'admin.ads_web.show';
        $this->form_new = 'admin.ads_web.new';
        $this->form_create = 'admin.ads_web.store';
        $this->form_edit = 'admin.ads_web.edit';
        $this->form_update = 'admin.ads_web.update';
        $this->form_delete = 'admin.ads_web.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = UserAdsWeb::paginate(7);
        ...
        // Render del view
        return view('web.admin.user_ads_webs.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        // Carga data para el view
        $data_item = UserAdsWeb::find($id_a);
        if ($data_item != null) {
            $id_sis = $data_item->id;
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.user_ads_webs.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
