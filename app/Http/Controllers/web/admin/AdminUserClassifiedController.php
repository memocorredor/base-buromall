...
class AdminUserClassifiedController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_user_classified_title');
        $this->seo_description = __('seo_admin.local_admin_user_classified_description');
        $this->seo_keywords = __('seo_admin.local_admin_user_classified_keywords');
        $this->view_icon = 'fas fa-bullhorn';
        // Rutas del view and form
        $this->form_view = 'admin.user_classified';
        $this->form_show = 'admin.user_classified.show';
        $this->form_new = 'admin.user_classified.new';
        $this->form_create = 'admin.user_classified.store';
        $this->form_edit = 'admin.user_classified.edit';
        $this->form_update = 'admin.user_classified.update';
        $this->form_delete = 'admin.user_classified.delete';
    }
    ...
    public function index()
    {
        ...
        // Render del view
        return view('web.admin.user_classifieds.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        if ($data_item != null) {
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.user_classifieds.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
