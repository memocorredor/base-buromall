...
class AdminUserGenderController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_user_gender_title');
        $this->seo_description = __('seo_admin.local_admin_user_gender_description');
        $this->seo_keywords = __('seo_admin.local_admin_user_gender_keywords');
        $this->view_icon = 'fas fa-venus-mars';
        // Rutas del view and form
        $this->form_view = 'admin.user_gender';
        $this->form_show = 'admin.user_gender.show';
        $this->form_new = 'admin.user_gender.new';
        $this->form_create = 'admin.user_gender.store';
        $this->form_edit = 'admin.user_gender.edit';
        $this->form_update = 'admin.user_gender.update';
        $this->form_delete = 'admin.user_gender.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = UserGender::paginate(7);
        ...
        // Render del view
        return view('web.admin.user_gender.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        // Carga data para el view
        $data_item = UserGender::find($id_a);
        if ($data_item != null) {
            $id_sis = $data_item->id;
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.user_gender.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
