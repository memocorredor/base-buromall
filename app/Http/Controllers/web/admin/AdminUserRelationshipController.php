...
class AdminUserRelationshipController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_user_relationship_title');
        $this->seo_description = __('seo_admin.local_admin_user_relationship_description');
        $this->seo_keywords = __('seo_admin.local_admin_user_relationship_keywords');
        $this->view_icon = 'fas fa-ring';
        // Rutas del view and form
        $this->form_view = 'admin.user_relationship';
        $this->form_show = 'admin.user_relationship.show';
        $this->form_new = 'admin.user_relationship.new';
        $this->form_create = 'admin.user_relationship.store';
        $this->form_edit = 'admin.user_relationship.edit';
        $this->form_update = 'admin.user_relationship.update';
        $this->form_delete = 'admin.user_relationship.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = UserRelationship::paginate(7);
        ...
        // Render del view
        return view('web.admin.user_relationship.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        // Carga data para el view
        $data_item = UserRelationship::find($id_a);
        if ($data_item != null) {
            $id_sis = $data_item->id;
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.user_relationship.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
    ...
    public function store(Request $request)
    {
        if ($request->get('process') === 'add') {
            ...
            // Crea la instancia
            $data_field = new UserRelationship();
    ...
    public function update(Request $request, $id)
    {
        ...
        $data_item = UserRelationship::find($id);
        if ($data_item != null) {
