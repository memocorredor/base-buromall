...
use Buromall\Models\UserStoreCupon;
...
class AdminUserStoreCuponController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_user_store_cupon_title');
        $this->seo_description = __('seo_admin.local_admin_user_store_cupon_description');
        $this->seo_keywords = __('seo_admin.local_admin_user_store_cupon_keywords');
        $this->view_icon = 'fas fa-crosshairs';
        // Rutas del view and form
        $this->form_view = 'admin.user_store_cupon';
        $this->form_show = 'admin.user_store_cupon.show';
        $this->form_new = 'admin.user_store_cupon.new';
        $this->form_create = 'admin.user_store_cupon.store';
        $this->form_edit = 'admin.user_store_cupon.edit';
        $this->form_update = 'admin.user_store_cupon.update';
        $this->form_delete = 'admin.user_store_cupon.delete';
    }
    ...
    public function index()
    {
        ...
        // Render del view
        return view('web.admin.user_store_cupon.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        if ($data_item != null) {
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.user_store_cupon.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
    ...
    public function store(Request $request)
    {
        if ($request->get('process') === 'add') {
            ...
            $next_cupons_id = $data_field->id;
            //check if image exist
            if ($request->hasFile('image')) {
                $images = $request->file('image');
                //Ruta para guardar
                $url_save_or = 'upload/cupons/' . $next_cupons_id . '/';
                ...
                foreach ($images as $key => $image) {
                    ...
                    $newPhoto->cupon_id = $next_cupons_id;
                    $newPhoto->event_id = 0;
