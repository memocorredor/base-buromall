...
class AdminUserStoreEventController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_user_store_event_title');
        $this->seo_description = __('seo_admin.local_admin_user_store_event_description');
        $this->seo_keywords = __('seo_admin.local_admin_user_store_event_keywords');
        $this->view_icon = 'fas fa-theater-masks';
        // Rutas del view and form
        $this->form_view = 'admin.user_store_event';
        $this->form_show = 'admin.user_store_event.show';
        $this->form_new = 'admin.user_store_event.new';
        $this->form_create = 'admin.user_store_event.store';
        $this->form_edit = 'admin.user_store_event.edit';
        $this->form_update = 'admin.user_store_event.update';
        $this->form_delete = 'admin.user_store_event.delete';
    }
    ...
    public function index()
    {
        ...
        // Render del view
        return view('web.admin.user_store_event.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        if ($data_item != null) {
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.user_store_event.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
