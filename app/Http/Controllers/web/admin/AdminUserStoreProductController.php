...
class AdminUserStoreProductController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_user_store_product_title');
        $this->seo_description = __('seo_admin.local_admin_user_store_product_description');
        $this->seo_keywords = __('seo_admin.local_admin_user_store_product_keywords');
        $this->view_icon = 'fas fa-gift';
        // Rutas del view and form
        $this->form_view = 'admin.user_store_product';
        $this->form_show = 'admin.user_store_product.show';
        $this->form_new = 'admin.user_store_product.new';
        $this->form_create = 'admin.user_store_product.store';
        $this->form_edit = 'admin.user_store_product.edit';
        $this->form_update = 'admin.user_store_product.update';
        $this->form_delete = 'admin.user_store_product.delete';
    }
    ...
    public function index()
    {
        ...
        // Render del view
        return view('web.admin.user_store_product.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        if ($data_item != null) {
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.user_store_product.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
    ...
    public function store(Request $request)
    {
        if ($request->get('process') === 'add') {
            $this->validate($request, [
                ...
                'shipping_description_es' => 'required|min:5',
                'shipping_description_en' => 'required|min:5',
                'shipping_description_pt' => 'required|min:5',
