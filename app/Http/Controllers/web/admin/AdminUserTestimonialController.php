...
use Buromall\Models\UserTestimonial;
...
class AdminUserTestimonialController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_admin.local_admin_user_testimonial_title');
        $this->seo_description = __('seo_admin.local_admin_user_testimonial_description');
        $this->seo_keywords = __('seo_admin.local_admin_user_testimonial_keywords');
        $this->view_icon = 'fas fa-comment-alt';
        // Rutas del view and form
        $this->form_view = 'admin.user_testimonial';
        $this->form_show = 'admin.user_testimonial.show';
        $this->form_new = 'admin.user_testimonial.new';
        $this->form_create = 'admin.user_testimonial.store';
        $this->form_edit = 'admin.user_testimonial.edit';
        $this->form_update = 'admin.user_testimonial.update';
        $this->form_delete = 'admin.user_testimonial.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = UserTestimonial::paginate(7);
        ...
        // Render del view
        return view('web.admin.user_testimonial.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        // Carga data para el view
        $data_item = UserTestimonial::find($id_a);
        if ($data_item != null) {
            $id_sis = $data_item->id;
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.admin.user_testimonial.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
    ...
    public function update(Request $request, $id)
    {
        ...
        $data_item = UserTestimonial::find($id);
        if ($data_item != null) {
            if ($request->get('process') === 'edit') {
                ...
                $data_item->text = $request->get('text');
                //Accion de guardar la info
