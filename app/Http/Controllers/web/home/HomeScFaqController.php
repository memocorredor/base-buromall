...
class HomeScFaqController extends Controller
{
    ...
    public function index()
    {
        ...
        $this->seo_title = __('seo_home.local_home_sc_faq_title');
        $this->seo_description = __('seo_home.local_home_sc_faq_description');
        $this->seo_keywords = __('seo_home.local_home_sc_faq_keywords');
        // Carga de combos
        $data_categories_faqs = ScCategorieFaq::all();
        ...
        //Carga del view
        return view('web.home.sc_faqs.main', [
            'meta_lang' => $this->lang,
            'meta_sis' => $for_meta_sis,
            'user_sis' => $this->user_sis,
            'icon' => $this->view_icon,
            'title_view' => $this->seo_title,
            'data_categories_faqs' => $data_categories_faqs
        ]);
    }
}
