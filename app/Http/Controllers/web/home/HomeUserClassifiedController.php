...
class HomeUserClassifiedController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->media_id = 'classified_id';
        //Url base para redirecion
        $this->item_url_base = 'home.user_classified_detail';
        //Name headers item
        $this->item_name_base = __('web_layout.local_classifieds');
        //Icon Cantidad
        $this->quantity_icon = 'fas fa-bullhorn';
        //Icon View
    ...
    public function index()
    {
        ...
        $this->seo_title = __('seo_home.local_home_user_classified_title');
        $this->seo_description = __('seo_home.local_home_user_classified_description');
        $this->seo_keywords = __('seo_home.local_home_user_classified_keywords');
        // Carga de combos
        $data_items = UserClassified::all();
        ...
        //Carga del view
        return view('web.home.user_classified.main', [
            'meta_lang' => $this->lang,
    ...
    public function indexDetail($id)
    {
        ...
        $data_view = UserClassified::where($filter, '=', $id_a)->firstOrFail();
        ...
        $latitude = $data_view->latitude;
        $longitude = $data_view->longitude;
        //Carga las imagenes
        ...
        //Base url qr
        $data_url = config('app.url') . __('route_home.home_user_classified_detail') . $url_title;
        ...
        $this->user_sis = CoreUser::getUser();
        //Carga del view
        return view('web.home.user_classified.detail', [
            'meta_lang' => $this->lang,
            'meta_sis' => $for_meta_sis,
            'user_sis' => $this->user_sis,
            'data_view' => $data_view,
