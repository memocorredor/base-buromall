...
class HomeUserPlanController extends Controller
{
    ...
    public function index()
    {
        ...
        $this->seo_title = __('seo_home.local_home_user_plan_title');
        $this->seo_description = __('seo_home.local_home_user_plan_description');
        $this->seo_keywords = __('seo_home.local_home_user_plan_keywords');
        // Carga de combos
        $data_user_plan = UserPlan::all();
