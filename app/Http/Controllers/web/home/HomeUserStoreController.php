...
class HomeUserStoreController extends Controller
{
    ...
    public function index()
    {
        ...
        $this->seo_title = __('seo_home.local_home_user_store_title');
        $this->seo_description = __('seo_home.local_home_user_store_description');
        $this->seo_keywords = __('seo_home.local_home_user_store_keywords');
        // Carga de combos
        $data_user_store = UserStore::all();
