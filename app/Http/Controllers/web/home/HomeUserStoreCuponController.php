...
class HomeUserStoreCuponController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->item_url_base = 'home.user_cupon_detail';
        //Name headers item
        $this->item_name_base = __('web_layout.local_cupon');
        //Icon Cantidad
    ...
    public function index()
    {
        ...
        $this->seo_title = __('seo_home.local_home_user_cupon_title');
        $this->seo_description = __('seo_home.local_home_user_cupon_description');
        $this->seo_keywords = __('seo_home.local_home_user_cupon_keywords');
        // Carga de combos
        $data_items = UserStoreCupon::all();
        ...
        //Carga del view
        return view('web.home.user_cupon.main', [
            'meta_lang' => $this->lang,
    ...
    public function indexDetail($id)
    {
        ...
        $data_view = UserStoreCupon::where($filter, '=', $id_a)->firstOrFail();
        ...
        $this->user_sis = CoreUser::getUser();
        //Carga del view
        return view('web.home.user_cupon.detail', [
            'meta_lang' => $this->lang,
            'meta_sis' => $for_meta_sis,
            'user_sis' => $this->user_sis,
            'data_view' => $data_view,
