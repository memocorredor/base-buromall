...
class HomeUserStoreEventController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->media_id = 'event_id';
        //Url base para redirecion
        $this->item_url_base = 'home.user_event_detail';
        //Name headers item
        $this->item_name_base = __('web_layout.local_events');
        //Icon Cantidad
    ...
    public function index()
    {
        ...
        $this->seo_title = __('seo_home.local_home_user_event_title');
        $this->seo_description = __('seo_home.local_home_user_event_description');
        $this->seo_keywords = __('seo_home.local_home_user_event_keywords');
        // Carga de combos
        $data_items = UserStoreEvent::all();
        ...
        //Carga del view
        return view('web.home.user_event.main', [
            'meta_lang' => $this->lang,
    ...
    public function indexDetail($id)
    {
        ...
        $data_view = UserStoreEvent::where($filter, '=', $id_a)->firstOrFail();
        ...
        //Carga el nombre del tipo de evento
        $type_event_id = TypeEvent::where('id', $data_view->type_transaction_id)->first();
        $type_event = $type_event_id->$name_items;
        ...
        //Base url qr
        $data_url = config('app.url') . __('app_route.lrhd_user_event') . $url_title;
        ...
        $this->user_sis = CoreUser::getUser();
        //Carga del view
        return view('web.home.user_event.detail', [
            'meta_lang' => $this->lang,
            'meta_sis' => $for_meta_sis,
            'user_sis' => $this->user_sis,
            'data_view' => $data_view,
