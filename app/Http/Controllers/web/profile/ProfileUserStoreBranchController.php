...
class ProfileUserStoreBranchController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_profile.local_profile_user_store_branch_title');
        $this->seo_description = __('seo_profile.local_profile_user_store_branch_description');
        $this->seo_keywords = __('seo_profile.local_profile_user_store_branch_keywords');
        $this->view_icon = 'fas fa-store';
        // Rutas del view and form
        $this->form_view = 'profile.user_branch';
        $this->form_show = 'profile.user_branch.show';
        $this->form_new = 'profile.user_branch.new';
        $this->form_create = 'profile.user_branch.store';
        $this->form_edit = 'profile.user_branch.edit';
        $this->form_update = 'profile.user_branch.update';
        $this->form_delete = 'profile.user_branch.delete';
    }
    ...
    public function index()
    {
        ...
        // Render del view
        return view('web.profile.user_store_branch.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        if ($data_item != null) {
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.profile.user_store_branch.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
