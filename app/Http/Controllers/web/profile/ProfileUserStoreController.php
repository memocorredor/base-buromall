...
class ProfileUserStoreController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_profile.local_profile_user_store_title');
        $this->seo_description = __('seo_profile.local_profile_user_store_description');
        $this->seo_keywords = __('seo_profile.local_profile_user_store_keywords');
        $this->view_icon = 'fas fa-store-alt';
        // Rutas del view and form
        $this->form_view = 'profile.user_store';
        $this->form_show = 'profile.user_store.show';
        $this->form_new = 'profile.user_store.new';
        $this->form_create = 'profile.user_store.store';
        $this->form_edit = 'profile.user_store.edit';
        $this->form_update = 'profile.user_store.update';
        $this->form_delete = 'profile.user_store.delete';
    }
    ...
    public function index()
    {
        ...
        $data_item = UserStore::where('user_id', Auth::user()->id)->paginate(7);
        ...
        // Render del view
        return view('web.profile.user_store.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    {
        $data_item = UserStore::where('id', $id)->get();
        if ($data_item != null) {
            $data_item->delete();
            $notification = array(
