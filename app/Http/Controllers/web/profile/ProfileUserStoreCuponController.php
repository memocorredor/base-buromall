...
class ProfileUserStoreCuponController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // SEO del form
        $this->seo_title = __('seo_profile.local_profile_user_store_cupon_title');
        $this->seo_description = __('seo_profile.local_profile_user_store_cupon_description');
        $this->seo_keywords = __('seo_profile.local_profile_user_store_cupon_keywords');
        $this->view_icon = 'fas fa-crosshairs';
        // Rutas del view and form
        $this->form_view = 'profile.user_cupon';
        $this->form_show = 'profile.user_cupon.show';
        $this->form_new = 'profile.user_cupon.new';
        $this->form_create = 'profile.user_cupon.store';
        $this->form_edit = 'profile.user_cupon.edit';
        $this->form_update = 'profile.user_cupon.update';
        $this->form_delete = 'profile.user_cupon.delete';
    }
    ...
    public function index()
    {
        ...
        // Render del view
        return view('web.profile.user_store_cupon.main', compact('data_item'), [
            'meta_lang' => $this->lang,
    ...
    public function show($id)
    {
        ...
        if ($data_item != null) {
            ...
            $this->user_sis = CoreUser::getUser();
            // Render del view
            return view('web.profile.user_store_cupon.form', [
                'meta_lang' => $this->lang,
                'seo_title' => $this->seo_title,
                'seo_description' => $this->seo_description,
                'meta_sis' => $for_meta_sis,
