...
class CreateCgCategoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cg_categories', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8';
        ...
        Schema::table('cg_categories', function ($table) {
    ...
    {
        Schema::dropIfExists('cg_categories');
    }
}
