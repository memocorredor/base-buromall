...
class CreateScAboutUsesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sc_about_uses', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8';
        ...
        Schema::table('sc_about_uses', function ($table) {
    ...
    {
        Schema::dropIfExists('sc_about_uses');
    }
}
