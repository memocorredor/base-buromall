...
class CreateScCancelationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sc_cancelations', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8';
        ...
        Schema::table('sc_cancelations', function ($table) {
    ...
    {
        Schema::dropIfExists('sc_cancelations');
    }
}
