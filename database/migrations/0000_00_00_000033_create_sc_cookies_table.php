...
class CreateScCookiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sc_cookies', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8';
        ...
        Schema::table('sc_cookies', function ($table) {
    ...
    {
        Schema::dropIfExists('sc_cookies');
    }
}
