...
class CreateScGuaranteesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sc_guarantees', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8';
        ...
        Schema::table('sc_guarantees', function ($table) {
    ...
    {
        Schema::dropIfExists('sc_guarantees');
    }
}
