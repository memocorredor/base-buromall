...
class CreateScIntPropiertiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sc_int_propierties', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8';
        ...
        Schema::table('sc_int_propierties', function ($table) {
    ...
    {
        Schema::dropIfExists('sc_int_propierties');
    }
}
