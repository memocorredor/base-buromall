...
class CreateScMisionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sc_misions', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8';
        ...
        Schema::table('sc_misions', function ($table) {
    ...
    {
        Schema::dropIfExists('sc_misions');
    }
}
