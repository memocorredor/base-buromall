...
class CreateScPrivaciesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sc_privacies', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8';
        ...
        Schema::table('sc_privacies', function ($table) {
    ...
    {
        Schema::dropIfExists('sc_privacies');
    }
}
