...
class CreateScRechargesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sc_recharges', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8';
        ...
        Schema::table('sc_recharges', function ($table) {
    ...
    {
        Schema::dropIfExists('sc_recharges');
    }
}
