...
class CreateScRefundsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sc_refunds', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8';
        ...
        Schema::table('sc_refunds', function ($table) {
    ...
    {
        Schema::dropIfExists('sc_refunds');
    }
}
