...
class CreateScReturnsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sc_returns', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8';
        ...
        Schema::table('sc_returns', function ($table) {
    ...
    {
        Schema::dropIfExists('sc_returns');
    }
}
