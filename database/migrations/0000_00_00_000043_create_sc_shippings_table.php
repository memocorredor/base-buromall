...
class CreateScShippingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sc_shippings', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8';
        ...
        Schema::table('sc_shippings', function ($table) {
    ...
    {
        Schema::dropIfExists('sc_shippings');
    }
}
