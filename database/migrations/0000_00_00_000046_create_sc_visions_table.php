...
class CreateScVisionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sc_visions', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8';
        ...
        Schema::table('sc_visions', function ($table) {
    ...
    {
        Schema::dropIfExists('sc_visions');
    }
}
