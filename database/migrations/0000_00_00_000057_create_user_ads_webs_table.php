...
class CreateUserAdsWebsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_ads_webs', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8';
        ...
        Schema::table('user_ads_webs', function ($table) {
    ...
    {
        Schema::dropIfExists('user_ads_webs');
    }
}
