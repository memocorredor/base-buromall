...
class CreateUserStoresTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('user_stores', function (Blueprint $table) {
            ...
            $table->string('url_name', 100)->nullable()->default('');
            ...
            $table->string('no_company', 60)->nullable()->default('');
            $table->string('merchant', 60)->nullable()->default('');
            $table->string('name_bank', 60)->nullable()->default('');
            $table->string('name_acount', 60)->nullable()->default('');
            $table->string('no_acount', 60)->nullable()->default('');
            $table->string('iban', 60)->nullable()->default('');
            $table->string('swift', 60)->nullable()->default('');
            $table->string('facebook', 60)->nullable()->default('');
            $table->integer('facebook_enable')->unsigned()->default('0');
            $table->string('twitter', 60)->nullable()->default('');
            $table->integer('twitter_enable')->unsigned()->default('0');
            $table->string('instagram', 60)->nullable()->default('');
            $table->integer('instagram_enable')->unsigned()->default('0');
            $table->string('pinterest', 60)->nullable()->default('');
            $table->integer('pinterest_enable')->unsigned()->default('0');
            $table->string('youtube', 60)->nullable()->default('');
            $table->integer('youtube_enable')->unsigned()->default('0');
            $table->string('linkedin', 60)->nullable()->default('');
            $table->integer('linkedin_enable')->unsigned()->default('0');
            $table->string('skype', 60)->nullable()->default('');
