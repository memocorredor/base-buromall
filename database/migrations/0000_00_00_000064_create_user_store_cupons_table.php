...
class CreateUserStoreCuponsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_store_cupons', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8';
        ...
        Schema::table('user_store_cupons', function ($table) {
    ...
    {
        Schema::dropIfExists('user_store_cupons');
    }
}
