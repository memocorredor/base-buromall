...
class CreateAcOrdersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('ac_orders', function (Blueprint $table) {
            ...
            $table->string('ref_procesor', 60)->nullable()->default('');
            ...
            $table->string('trm_id', 100)->nullable()->default('');
            $table->string('trm_usd', 60)->nullable()->default('');
            $table->string('trm_cop', 60)->nullable()->default('');
            $table->string('trml_usd', 60)->nullable()->default('');
            $table->string('trml_cop', 60)->nullable()->default('');
            $table->string('trm_cop_sis', 60)->nullable()->default('');
            $table->string('sis_cart_stotal', 60)->nullable()->default('');
            $table->string('sis_cart_tax', 60)->nullable()->default('');
            $table->string('sis_cart_shipping', 60)->nullable()->default('');
            $table->string('sis_cart_total', 60)->nullable()->default('');
            $table->string('sis_costo_proce', 60)->nullable()->default('');
            ...
            $table->string('cart_costo_proce', 100)->nullable()->default('');
            $table->string('cart_result_check', 100)->nullable()->default('');
            $table->string('cart_result_sistem', 100)->nullable()->default('');
            $table->string('cart_result_trm', 100)->nullable()->default('');
            $table->string('usr_stotal', 100)->nullable()->default('');
            $table->string('usr_tax', 100)->nullable()->default('');
            $table->string('usr_shipping', 100)->nullable()->default('');
            $table->string('usr_total', 100)->nullable()->default('');
            $table->string('usr_costo_proce', 100)->nullable()->default('');
            $table->string('usr_result_sistem', 100)->nullable()->default('');
