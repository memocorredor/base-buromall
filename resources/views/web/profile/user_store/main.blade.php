                ...
                <table class="display w-100 d-block d-md-table table table-hover" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @endif
                            <td class="text-center" style="width: 30px;"><img src="{{ asset($row_items->image) }}" class="img-fluid" style="min-height: 30px"/></td>
                            <td class="text-center">{{  $row_items->name }}</td>
                            <td class="text-center">{{  $row_items->nameUsername->username }}</td>
